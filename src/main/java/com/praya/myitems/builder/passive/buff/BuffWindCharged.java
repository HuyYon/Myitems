...
public class BuffWindCharged extends PassiveEffect
{
    private static final PassiveEffectEnum buff;

    static {
        buff = PassiveEffectEnum.WIND_CHARGED;
    }

    public BuffWindCharged() {
        super(BuffWindCharged.buff, 1);
    }

    public BuffWindCharged(final int grade) {
        super(BuffWindCharged.buff, grade);
    }
