...
public class BuffDolphinGrace extends PassiveEffect
{
    ...
    public BuffDolphinGrace() {
        super(BuffDolphinGrace.buff, 1);
    }

    public BuffDolphinGrace(final int grade) {
        super(BuffDolphinGrace.buff, grade);
    }
