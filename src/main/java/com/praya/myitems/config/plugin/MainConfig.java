...
public class MainConfig extends HandlerConfig
{
    ...
    public final String getPassiveBuffIdentifierWindCharged() {
        return this.config.getString("Configuration.Passive.Buff.Identifier_Wind_Charged");
    }

    public final String getPassiveBuffIdentifierWeaving() {
        return this.config.getString("Configuration.Passive.Buff.Identifier_Weaving");
    }

    public final String getPassiveBuffIdentifierDolphinGrace() {
        return this.config.getString("Configuration.Passive.Buff.Identifier_Dolphin_Grace");
    }

    public final String getPassiveBuffIdentifierConduitPower() {
        return this.config.getString("Configuration.Passive.Buff.Identifier_Conduit_Power");
    }
    ...
    public final String getPassiveDebuffIdentifierOozing() {
        return this.config.getString("Configuration.Passive.Debuff.Identifier_Oozing");
    }

    public final String getPassiveDebuffIdentifierInfested() {
        return this.config.getString("Configuration.Passive.Debuff.Identifier_Infested");
    }

    public final String getPassiveDebuffIdentifierDarkness() {
        return this.config.getString("Configuration.Passive.Debuff.Identifier_Darkness");
    }
                        ...
                        for (final String passiveData : passiveDataSection.getKeys(false)) {
                            if (passiveData.equalsIgnoreCase("Enable_Grade_Calculation")) {
                                ...
                                for (final String passiveBuffData : passiveBuffDataSection.getKeys(false)) {
                                    ...
                                    else if (passiveBuffData.equalsIgnoreCase("Identifier_Wind_Charged")) {
                                        final String path2 = "Configuration.Passive.Buff.Identifier_Wind_Charged";
                                        final String passiveBuffIdentifierWindCharged = passiveBuffDataSection.getString(passiveBuffData);
                                        config.set("Configuration.Passive.Buff.Identifier_Wind_Charged", (Object)TextUtil.colorful(passiveBuffIdentifierWindCharged));
                                    }
                                    else if (passiveBuffData.equalsIgnoreCase("Identifier_Weaving")) {
                                        final String path2 = "Configuration.Passive.Buff.Identifier_Weaving";
                                        final String passiveBuffIdentifierWeaving = passiveBuffDataSection.getString(passiveBuffData);
                                        config.set("Configuration.Passive.Buff.Identifier_Weaving", (Object)TextUtil.colorful(passiveBuffIdentifierWeaving));
                                    }
                                    else if (passiveBuffData.equalsIgnoreCase("Identifier_Dolphin_Grace")) {
                                        final String path2 = "Configuration.Passive.Buff.Identifier_Dolphin_Grace";
                                        final String passiveBuffIdentifierDolphinGrace = passiveBuffDataSection.getString(passiveBuffData);
                                        config.set("Configuration.Passive.Buff.Identifier_Dolphin_Grace", (Object)TextUtil.colorful(passiveBuffIdentifierDolphinGrace));
                                    }
                                    else if (passiveBuffData.equalsIgnoreCase("Identifier_Conduit_Power")) {
                                        final String path2 = "Configuration.Passive.Buff.Identifier_Conduit_Power";
                                        final String passiveBuffIdentifierConduitPower = passiveBuffDataSection.getString(passiveBuffData);
                                        config.set("Configuration.Passive.Buff.Identifier_Conduit_Power", (Object)TextUtil.colorful(passiveBuffIdentifierConduitPower));
                                    }
                                    else {
                                ...
                                for (final String passiveDebuffData : passiveDebuffDataSection.getKeys(false)) {
                                    ...
                                    else if (passiveDebuffData.equalsIgnoreCase("Identifier_Oozing")) {
                                        final String path2 = "Configuration.Passive.Debuff.Identifier_Oozing";
                                        final String passiveDebuffIdentifierOozing = passiveDebuffDataSection.getString(passiveDebuffData);
                                        config.set("Configuration.Passive.Debuff.Identifier_Oozing", (Object)TextUtil.colorful(passiveDebuffIdentifierOozing));
                                    }
                                    else if (passiveDebuffData.equalsIgnoreCase("Identifier_Infested")) {
                                        final String path2 = "Configuration.Passive.Debuff.Identifier_Infested";
                                        final String passiveDebuffIdentifierInfested = passiveDebuffDataSection.getString(passiveDebuffData);
                                        config.set("Configuration.Passive.Debuff.Identifier_Infested", (Object)TextUtil.colorful(passiveDebuffIdentifierInfested));
                                    }
                                    else if (passiveDebuffData.equalsIgnoreCase("Identifier_Darkness")) {
                                        final String path2 = "Configuration.Passive.Debuff.Identifier_Darkness";
                                        final String passiveDebuffIdentifierDarkness = passiveDebuffDataSection.getString(passiveDebuffData);
                                        config.set("Configuration.Passive.Debuff.Identifier_Darkness", (Object)TextUtil.colorful(passiveDebuffIdentifierDarkness));
                                    }
