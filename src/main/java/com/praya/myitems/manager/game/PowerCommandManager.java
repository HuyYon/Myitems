...
public class PowerCommandManager extends HandlerManager {
    ...
    /**
     * @deprecated Use {@link PowerCommandProperties#getLore()} directly via
     *             {@link #getPowerCommandProperties(String)} instead.
     */
    @Deprecated
    ...
    /**
     * @deprecated Use {@link PowerCommandProperties#getCommands()} directly via
     *             {@link #getPowerCommandProperties(String)} instead.
     */
    @Deprecated
    public final List<String> getCommands(final String powerCommand) {
        final PowerCommandProperties build = this.getPowerCommandProperties(powerCommand);
        return (build != null) ? build.getCommands() : new ArrayList<>();
    }
    ...
    public final String getCommandKeyByLore(final String lore) {
        ...
        for (final String key : this.getPowerCommandIDs()) {
            ...
            if (powerCommandProperties != null
                    && powerCommandProperties.getKeyLore().equalsIgnoreCase(coloredLore)) {
                return key;
            }
        }
        return null;
