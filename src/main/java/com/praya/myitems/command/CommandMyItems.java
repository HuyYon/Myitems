...
public class CommandMyItems extends HandlerCommand implements CommandExecutor {
    ...
    private void registerSubCommands() {
        subCommands.put("att", new CommandAttributes(plugin));
        subCommands.put("enchant", new CommandEnchant(plugin));
        subCommands.put("addenchant", new CommandEnchantAdd(plugin));
        subCommands.put("remenchant", new CommandEnchantRemove(plugin));
        subCommands.put("clearenchant", new CommandEnchantClear(plugin));
        subCommands.put("setname", new CommandItemName(plugin));
        subCommands.put("lore", new CommandLore(plugin));
        subCommands.put("addlore", new CommandLoreAdd(plugin));
        subCommands.put("setlore", new CommandLoreSet(plugin));
        subCommands.put("insertlore", new CommandLoreInsert(plugin));
        subCommands.put("remlore", new CommandLoreRemove(plugin));
        subCommands.put("clearlore", new CommandLoreClear(plugin));
        subCommands.put("clearnbt", new CommandNBTClear(plugin));
        subCommands.put("socket", new CommandSocket(plugin));
        subCommands.put("unbreakable", new CommandUnbreakable(plugin));
        SubCommand notCompatible = new CommandNotCompatible(plugin);
        if (ServerUtil.isCompatible(VersionNMS.V1_21_R3)) {
            subCommands.put("flag", new CommandFlag(plugin));
            subCommands.put("addflag", new CommandFlagAdd(plugin));
            subCommands.put("remflag", new CommandFlagRemove(plugin));
            subCommands.put("clearflag", new CommandFlagClear(plugin));
        } else {
            subCommands.put("flag", notCompatible);
            subCommands.put("addflag", notCompatible);
            subCommands.put("remflag", notCompatible);
            subCommands.put("clearflag", notCompatible);
        }
    }
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        final String subLabel = args[0].toLowerCase();
        if (subCommands.containsKey(subLabel)) {
            final String[] subArgs = Arrays.copyOfRange(args, 1, args.length);
            final SubCommand sub = subCommands.get(subLabel);
            return sub.onSubCommand(sender, command, label, subArgs);
        }
        if (commandManager.checkCommand(subLabel, "MyItems_Reload")) {
        ...
        else if (commandManager.checkCommand(subLabel, "MyItems_About")) {
        ...
        else if (commandManager.checkCommand(subLabel, "MyItems_Save")) {
        ...
        else if (commandManager.checkCommand(subLabel, "MyItems_Remove")) {
        ...
        else if (commandManager.checkCommand(subLabel, "MyItems_Drop")) {
        ...
        else if (commandManager.checkCommand(subLabel, "MyItems_Load")) {
        ...
        else if (commandManager.checkCommand(subLabel, "MyItems_Amount")) {
        ...
        else if (commandManager.checkCommand(subLabel, "MyItems_Data")) {
        ...
        else if (commandManager.checkCommand(subLabel, "MyItems_Material")) {
        ...
        else if (commandManager.checkCommand(subLabel, "MyItems_Repair")) {
        ...
        else if (commandManager.checkCommand(subLabel, "MyItems_Detail")) {
        ...
        else if (commandManager.checkCommand(subLabel, "MyItems_Stats")) {
            ...
            if (commandManager.checkCommand(subLabel, "MyItems_Help")) {
                return help(sender, command, label, args);            }
            if (commandManager.checkCommand(subLabel, "MyItems_List")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                list(sender, command, label, fullArgs2);
                return true;
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Name")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                return CommandItemName.setName(sender, command, label, fullArgs2);
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Lore_Set")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                return CommandLoreSet.setLore(sender, command, label, fullArgs2);
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Lore_Insert")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                return CommandLoreInsert.insertLore(sender, command, label, fullArgs2);
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Lore_Add")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                return CommandLoreAdd.addLore(sender, command, label, fullArgs2);
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Lore_Remove")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                return CommandLoreRemove.removeLore(sender, command, label, fullArgs2);
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Lore_Clear")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                return CommandLoreClear.clearLore(sender, command, label, fullArgs2);
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Flag_Add")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                return CommandFlagAdd.addFlag(sender, command, label, fullArgs2);
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Flag_Remove")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                return CommandFlagRemove.removeFlag(sender, command, label, fullArgs2);
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Flag_Clear")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                return CommandFlagClear.clearFlag(sender, command, label, fullArgs2);
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Enchant_Add")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                return CommandEnchantAdd.addEnchant(sender, command, label, fullArgs2);
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Enchant_Remove")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                return CommandEnchantRemove.removeEnchant(sender, command, label, fullArgs2);
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Enchant_Clear")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
                return CommandEnchantClear.clearEnchant(sender, command, label, fullArgs2);
            }
            if (commandManager.checkCommand(subLabel, "MyItems_Unbreakable")) {
                final String[] fullArgs2 = TextUtil.pressList(args, 2);
    ...
    protected static final boolean help(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        if (args.length > 0) {
            if (args[0].equalsIgnoreCase("help")) {
                if (args.length > 1) {
                    page = MathUtil.parseInteger(args[1]);
                }
            } else if (MathUtil.isNumber(args[0])) {
                page = MathUtil.parseInteger(args[0]);
            }
        }
        ...
        String previousTooltip = "||&6&l\u25c0||ttp: {text_previous_page}||cmd: /mi help {previous_page}||";
        String nextTooltip = "||&6&l\u25b6||ttp: {text_next_page}||cmd: /mi help {next_page}||";
